...
module.exports = function log(tree, _options) {
  return new Log(tree, parseOptions(arguments.length, _options));
};

class Log extends Plugin {
  constructor(input, options) {
    super([input], {
      name: `stew.log ${options.label || ''}`,
      annotation: options.annotation || options.label,
