...
module.exports = function find(tree, a, b) {
  console.warn("stew.find is deprecated, use broccoli-funnel instead. Details at https://github.com/stefanpenner/broccoli-stew/blob/master/DEPRECATIONS.md#stew.find.")
