beforeBuild = require('./beforeBuild')
afterBuild = require('./afterBuild')
 ...
 */
function wrapBuild(tree, beforeCb, afterCb) {
  if (tree === null || tree === undefined) {
    throw new Error('No inputTree passed to stew.wrapBuild');
  }
